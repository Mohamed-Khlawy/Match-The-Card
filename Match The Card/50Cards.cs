...
{
    public partial class _50Cards : Form
    {
        GameLevel gameLevel;
        int currentPlayer = 1;
        ...
        string Player2name = "";
        string Player3name = "";
        public _50Cards(int _NumberOfPlayers, GameLevel _gameLevel,
        ...
        private int[] GenerateIntArrayFrom1To25()
        {
        ...
        private void ShuffleArray(int[] array) //To shuffe the 1 to 25 array for Expert Version 
        {
            int n = array.Length;
            while (n > 1)
            {
        ...
        {
            int[] numbersArray = GenerateIntArrayFrom1To25();
            ...
            //Fill first 5 rows with 25 cards from 1 to 25
            ...
            index--;  //To Start the next two nested loops with 25 and go down

            //Fill second 5 rows with 25 cards from 1 to 25
        ...
        private void Update_Points_Panel()
        {
            ...
            {
                label_Player1Name.Text = Player1name + " : ";
                Player1Points.Text = playerScores[0].ToString() + " Points";
                label_Player2Name.Visible = false;
                Player2Points.Visible = false;
                label_Player3Name.Visible = false;
                Player3Points.Visible = false;
            }
            else if (numberOfPlayers == 2)
            {
                label_Player1Name.Text = Player1name + " : ";
                label_Player2Name.Text = Player2name + " : ";
                Player1Points.Text = playerScores[0].ToString() + " Points";
            ...
            else if (numberOfPlayers == 3)
            {
                label_Player1Name.Text = Player1name + " : ";
                label_Player2Name.Text = Player2name + " : ";
                label_Player3Name.Text = Player3name + " : ";
                Player1Points.Text = playerScores[0].ToString() + " Points";
                Player2Points.Text = playerScores[1].ToString() + " Points";
            ...
            //Matched cards
            lbl_Matched_Cards.Text = matchedCount.ToString() + " / 25";
        ...
        private void _50Cards_Load(object sender, EventArgs e)
        {
            Update_Points_Panel();
        }
        private void Game_Summary()
        {
            ...
            {
                DialogResult summary = MessageBox.Show($"Your time is: {lbl_Timer.Text} \n" +
                    $"{label_Player1Name.Text} points are: {playerScores[0]} \n" +
                    $"{label_Player2Name.Text} points are: {playerScores[1]} \n" +
                    $"Number of Right Chooses are: {rightChoose} \n" +
                    $"Number of Wrong Chooses are: {wrongChoose} \n"
                    ,
                 "Match The Card Summary", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
            ...
            else if (numberOfPlayers == 3)
            {
                DialogResult summary = MessageBox.Show($"Your time is: {lbl_Timer.Text} \n" +
                    $"{label_Player1Name.Text} points are: {playerScores[0]} \n" +
                    $"{label_Player2Name.Text} points are: {playerScores[1]} \n" +
                    $"{label_Player3Name.Text} points are: {playerScores[2]} \n" +
                    $"Number of Right Chooses are: {rightChoose} \n" +
                    $"Number of Wrong Chooses are: {wrongChoose} \n"
                    ,
                 "Match The Card Summary", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
        ...
        private void _50Cards_FormClosing(object sender, FormClosingEventArgs e)
        {
